...
FPalPassiveSkillDatabaseRow::FPalPassiveSkillDatabaseRow() {
    ...
    this->TargetType1 = EPalPassiveSkillEffectTargetType::ToSelf;
    this->EffectType2 = EPalPassiveSkillEffectType::no;
    this->EffectValue2 = 0.00f;
    this->TargetType2 = EPalPassiveSkillEffectTargetType::ToSelf;
    this->EffectType3 = EPalPassiveSkillEffectType::no;
    this->EffectValue3 = 0.00f;
    this->TargetType3 = EPalPassiveSkillEffectTargetType::ToSelf;
    this->EffectType4 = EPalPassiveSkillEffectType::no;
    this->EffectValue4 = 0.00f;
    this->TargetType4 = EPalPassiveSkillEffectTargetType::ToSelf;
