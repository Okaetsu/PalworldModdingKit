...
void UPalAnimNotify_FootStep::SpawnFootStepEffect(AActor* Owner, EPalLandingType LandingType, TEnumAsByte<EPhysicalSurface> PhysicalSurface, const FVector& Location, const FRotator& Rotation, UPalStaticCharacterParameterComponent* StaticParam, const float Scale, UNiagaraSystem* OverrideEffect) const {
}
